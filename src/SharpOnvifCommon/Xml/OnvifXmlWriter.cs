...
namespace SharpOnvifCommon.Xml
{
    ...
    /// </para>
    /// </summary>
    public sealed class OnvifXmlWriter : IXmlWriter
    {
        ...
        /// <summary>
        /// The lexical forms, which are the schema's rather than the writer's - they are reachable
        /// through the writer because a contract always has one to hand while it is writing.
        /// </summary>
        public string ToXml(bool value) { return XmlPrimitives.ToString(value); }

        public string ToXml(sbyte value) { return XmlPrimitives.ToString(value); }
        public string ToXml(byte value) { return XmlPrimitives.ToString(value); }
        public string ToXml(short value) { return XmlPrimitives.ToString(value); }
        public string ToXml(ushort value) { return XmlPrimitives.ToString(value); }
        public string ToXml(int value) { return XmlPrimitives.ToString(value); }
        public string ToXml(uint value) { return XmlPrimitives.ToString(value); }
        public string ToXml(long value) { return XmlPrimitives.ToString(value); }
        public string ToXml(ulong value) { return XmlPrimitives.ToString(value); }
        public string ToXml(decimal value) { return XmlPrimitives.ToString(value); }
        public string ToXml(float value) { return XmlPrimitives.ToString(value); }
        public string ToXml(double value) { return XmlPrimitives.ToString(value); }
        public string ToXml(DateTime value) { return XmlPrimitives.ToString(value); }
        public string ToXml(byte[] value) { return XmlPrimitives.ToString(value); }

        public string ToDateString(DateTime value) { return XmlPrimitives.ToDateString(value); }

        public string ToTimeString(DateTime value) { return XmlPrimitives.ToTimeString(value); }

        public string ToHexString(byte[] value) { return XmlPrimitives.ToHexString(value); }

        public string JoinList(IEnumerable<string> values) { return OnvifArray.JoinList(values); }
    }
}
