...
namespace OnvifScThermal
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("CoreWCF", "4.0.0.0")]
    [CoreWCF.ServiceContractAttribute(Namespace="http://www.onvif.org/ver10/thermal/wsdl", ConfigurationName="OnvifScThermal.ThermalPort")]
    public interface ThermalPort
    {
        ...
        OnvifScThermal.Capabilities GetServiceCapabilities();
        ...
        OnvifScThermal.ConfigurationOptions GetConfigurationOptions(string VideoSourceToken);
        ...
        OnvifScThermal.Configuration GetConfiguration(string VideoSourceToken);
        ...
        OnvifScThermal.GetConfigurationsResponse GetConfigurations(OnvifScThermal.GetConfigurationsRequest request);
        
        [CoreWCF.OperationContractAttribute(Action="http://www.onvif.org/ver10/thermal/wsdl/SetConfiguration")]
        [CoreWCF.XmlSerializerFormatAttribute()]
        void SetConfiguration(string VideoSourceToken, OnvifScThermal.Configuration Configuration);
        
        [CoreWCF.OperationContractAttribute(Action="http://www.onvif.org/ver10/thermal/wsdl/GetRadiometryConfigurationOptions")]
        [CoreWCF.XmlSerializerFormatAttribute()]
        [return: CoreWCF.MessageParameterAttribute(Name="ConfigurationOptions")]
        OnvifScThermal.RadiometryConfigurationOptions GetRadiometryConfigurationOptions(string VideoSourceToken);
        
        [CoreWCF.OperationContractAttribute(Action="http://www.onvif.org/ver10/thermal/wsdl/GetRadiometryConfiguration")]
        [CoreWCF.XmlSerializerFormatAttribute()]
        [return: CoreWCF.MessageParameterAttribute(Name="Configuration")]
        OnvifScThermal.RadiometryConfiguration GetRadiometryConfiguration(string VideoSourceToken);
        
        [CoreWCF.OperationContractAttribute(Action="http://www.onvif.org/ver10/thermal/wsdl/SetRadiometryConfiguration")]
        [CoreWCF.XmlSerializerFormatAttribute()]
        void SetRadiometryConfiguration(string VideoSourceToken, OnvifScThermal.RadiometryConfiguration Configuration);
    }
    ...
    public partial class GetConfigurationsResponse
    {
        ...
        public OnvifScThermal.Configurations[] Configurations;
        
        public GetConfigurationsResponse()
        {
        }
        
        public GetConfigurationsResponse(OnvifScThermal.Configurations[] Configurations)
        {
