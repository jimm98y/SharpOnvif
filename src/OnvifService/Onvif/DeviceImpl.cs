...
namespace OnvifService.Onvif
{
  public class DeviceImpl : DeviceBase
  {
    ...
    public DeviceImpl(IServer server, ILogger<DeviceImpl> logger, IConfiguration configuration)
    {
      ...
      PrimaryIPv4Address = _configuration.GetValue(
        "OnvifDiscovery:IPv4Address",
        GetPrimaryIPv4Address()
      );
      PrimaryIPv4DNS = _configuration.GetValue(
        "DeviceImpl:PrimaryIPv4DNS",
        GetPrimaryIPv4DNS()
      );
      PrimaryMACAddress = _configuration.GetValue("OnvifDiscovery:MAC", GetPrimaryMACAddress());
      PrimaryNICName = _configuration.GetValue("OnvifDiscovery:NICName", GetPrimaryNICName());
      PrimaryNTPAddress = _configuration.GetValue(
        "DeviceImpl:PrimaryNTPAddress",
        GetPrimaryNTPAddress()
      );
      PrimaryIPv4Gateway = _configuration.GetValue(
        "DeviceImpl:PrimaryIPv4Gateway",
        GetPrimaryIPv4Gateway()
      );
    }
      ...
      return new GetCapabilitiesResponse()
      {
        Capabilities = new Capabilities()
        {
          Device = new DeviceCapabilities()
          {
            ...
            IO = new IOCapabilities() { InputConnectors = 0, RelayOutputs = 0 },
            Security = new SecurityCapabilities1() { TLS12 = true },
          },
    ...
    public override GetDeviceInformationResponse GetDeviceInformation(
      GetDeviceInformationRequest request
    )
    {
    ...
    public override DNSInformation GetDNS()
    {
      ...
      {
        DNSManual = new IPAddress[] { new IPAddress() { IPv4Address = PrimaryIPv4DNS } },
      };
    }

    public override GetNetworkInterfacesResponse GetNetworkInterfaces(
          ...
          new NetworkInterface()
          {
            ...
            IPv4 = new IPv4NetworkInterface()
            {
              Config = new IPv4Configuration()
              {
                ...
                {
                  new PrefixedIPv4Address() { Address = PrimaryIPv4Address, PrefixLength = 24 },
                },
              },
              Enabled = true,
            },
    ...
    public override NTPInformation GetNTP()
    {
      ...
      {
        NTPManual = new NetworkHost[] { new NetworkHost() { IPv4Address = PrimaryNTPAddress } },
      };
    }
    ...
    {
      return new HostnameInformation() { Name = new Uri(_server.GetHttpEndpoint()).Host };
    }

    [return: MessageParameter(Name = "NetworkProtocols")]
    public override GetNetworkProtocolsResponse GetNetworkProtocols(
    ...
    {
      return new NetworkGateway() { IPv4Address = new string[] { PrimaryIPv4Gateway } };
    }
    ...
    public override GetUsersResponse GetUsers(GetUsersRequest request)
    {
      return new GetUsersResponse()
      {
        User = new User[]
        {
          new User() { Username = "admin", UserLevel = UserLevel.Administrator },
        },
      };
    }
    ...
    {
      return new SystemLog() { String = "log" };
    }
    ...
    public override GetCertificatesStatusResponse GetCertificatesStatus(
    ...
    )
    {
      return new GetCertificatesStatusResponse()
      {
        ...
        {
          new CertificateStatus() { CertificateID = CERTIFICATE_ID, Status = true },
        },
      };
    }

    public override void SetSystemDateAndTime(
      SetDateTimeType DateTimeType,
      bool DaylightSavings,
      SharpOnvifServer.DeviceMgmt.TimeZone TimeZone,
      SharpOnvifServer.DeviceMgmt.DateTime UTCDateTime
    )
    {
      _logger.LogInformation("Device: SetSystemDateAndTime");
    }

    public override void SetRelayOutputState(
    ...
    public override void SetRelayOutputSettings(
      string RelayOutputToken,
    ...
    public static string GetPrimaryIPv4Address()
    {
      ...
      if (nic != null)
      {
        ...
        if (nicProperties != null)
        {
          ...
          {
            var unicastAddress = unicastAddresses.FirstOrDefault(x =>
              x.Address != null
    ...
    public static string GetPrimaryIPv4DNS()
    {
      ...
      if (nic != null)
      {
        ...
        if (nicProperties != null)
        {
          ...
          {
            var dnsAddress = dnsAddresses.FirstOrDefault(x =>
    ...
    public static string GetPrimaryNTPAddress(string ntp = "time.windows.com")
    {
      ...
      if (dnsHostEntry != null)
      {
        ...
        if (addressList != null)
        {
          var ntpAddress = addressList.FirstOrDefault(x =>
            x.AddressFamily == System.Net.Sockets.AddressFamily.InterNetwork
          );
          if (ntpAddress != null)
          {
    ...
    public static string GetPrimaryIPv4Gateway()
    {
      ...
      if (nic != null)
      {
        ...
        if (nicProperties != null)
        {
          ...
          {
            var gatewayAddress = gatewayAddresses.FirstOrDefault(x =>
              x.Address != null
              && x.Address.AddressFamily == System.Net.Sockets.AddressFamily.InterNetwork
            );
    ...
    public static string GetPrimaryNICName()
    {
      string ret = "eth0";
      var nic = GetPrimaryNetworkInterface();
      if (nic != null)
      {
        ...
        if (nicName != null && nicName != string.Empty)
        {
          ret = nicName;
        }
      }
